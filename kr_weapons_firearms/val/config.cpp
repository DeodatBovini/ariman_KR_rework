class CfgPatches
{
	class Kletka_kr_weapons_firearms_val
	{
		units[]={};
		weapons[]=
		{
...
class cfgWeapons
{
	...
	class kr_VAL_Base: Rifle_Base
	{
		...
		{
			"KR\weapons\kr_weaponpack\kr_weapons_firearms\val\data\val_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"KR\weapons\kr_weaponpack\kr_weapons_firearms\val\data\val.rvmat"
		};
		hiddenSelections[]=
		{
			"camo"
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"KR\weapons\kr_weaponpack\kr_weapons_firearms\val\data\val_worn.rvmat"
							}
						},
						
						{
							...
							{
								"KR\weapons\kr_weaponpack\kr_weapons_firearms\val\data\val_damage.rvmat"
							}
						},
						
						{
							...
							{
								"KR\weapons\kr_weaponpack\kr_weapons_firearms\val\data\val_badlydamage.rvmat"
							}
						},
						
						{
							...
							{
								"KR\weapons\kr_weaponpack\kr_weapons_firearms\val\data\val_destruct.rvmat"
							}
						}
					};
				};
