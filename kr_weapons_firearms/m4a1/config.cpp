class CfgPatches
{
	class Kletka_kr_weapons_firearms_m4
	{
		units[]={};
		weapons[]=
		{
...
class cfgWeapons
{
	...
	class kr_M4A1_Base: Rifle_Base
	{
		...
		repairCosts[]={25};
		PPDOFProperties[]={0,0.60000002,50,200,4,10};
		attachments[]=
		{
			"kr_muzzle556",
			"kr_ar15_hndgrd",
		...
		{
			"KR\weapons\kr_weaponpack\kr_weapons_firearms\m4a1\data\m4a1_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"KR\weapons\kr_weaponpack\kr_weapons_firearms\m4a1\data\m4a1.rvmat"
		};
		magazines[]=
		{
			"Mag_STANAG_30Rnd",
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"KR\weapons\kr_weaponpack\kr_weapons_firearms\m4a1\data\m4a1_worn.rvmat"
							}
						},
						
						{
							...
							{
								"KR\weapons\kr_weaponpack\kr_weapons_firearms\m4a1\data\m4a1_damage.rvmat"
							}
						},
						
						{
							...
							{
								"KR\weapons\kr_weaponpack\kr_weapons_firearms\m4a1\data\m4a1_badlydamage.rvmat"
							}
						},
						
						{
							...
							{
								"KR\weapons\kr_weaponpack\kr_weapons_firearms\m4a1\data\m4a1_destruct.rvmat"
							}
						}
					};
				};
	...
	class kr_m4a1_260mm: kr_M4A1_Base
	{
		...
		itemSize[]={7,3};
		weight=3406;
		WeaponLength=0.64600003;
		initSpeedMultiplier=0.94999999;
		barrelArmor=7;
